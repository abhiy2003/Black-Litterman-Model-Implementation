...
# Graph
ax.set_title('Optimal Portfolio Allocation % - Monthly Average')
...
# ---------- Standard Deviation of Allocation Weights by ETF Plot ----------

# Preserve ETF order
etf_order = daily_weights.columns.tolist()
weights_std = daily_weights[etf_order].std()

max_val = weights_std.max()  # max bar height

# Round up to the next 1% (0.01)
ceiling = math.ceil(max_val * 100) / 100
...
# Graph
ax.set_title('Standard Deviation of Daily Allocation Weights by ETF')
